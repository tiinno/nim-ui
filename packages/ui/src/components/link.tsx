...
const linkVariants = cva(
  'rounded-sm transition-colors focus-visible:outline-2 focus-visible:outline-primary-500 dark:focus-visible:outline-primary-400 focus-visible:outline-offset-2',
  {
    variants: {
      variant: {
