      ...
      items.map((item) => {
        ...
        return (
          <li
            ...
            className="block outline-none [&:focus-visible>div]:outline-2 [&:focus-visible>div]:outline-primary-500 dark:[&:focus-visible>div]:outline-primary-400 [&:focus-visible>div]:outline-offset-2"
          >
            <div
