...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Content
    ref={ref}
    className="overflow-hidden text-sm data-[state=closed]:animate-accordion-up data-[state=closed]:motion-reduce:animate-none data-[state=open]:animate-accordion-down data-[state=open]:motion-reduce:animate-none"
    {...props}
  >
