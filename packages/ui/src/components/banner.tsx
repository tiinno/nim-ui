...
const bannerVariants = cva(
  'relative flex w-full items-center gap-3 border-b px-4 py-2.5 text-sm transition-opacity duration-(--duration-normal) sm:px-6',
  {
    variants: {
      tone: {
        neutral:
      ...
      >
        ...
        {dismissible && (
          <button
            ...
            className="absolute right-3 top-1/2 inline-flex size-7 -translate-y-1/2 cursor-pointer items-center justify-center rounded-md opacity-70 transition-opacity duration-(--duration-fast) hover:opacity-100 active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-400 sm:right-4"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="14"
