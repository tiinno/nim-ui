...
const viewSwitcherItemVariants = cva(
  'group inline-flex min-w-max items-center gap-2 rounded-md text-left font-medium outline-none transition-colors duration-(--duration-fast) focus-visible:ring-2 focus-visible:ring-primary-500 dark:focus-visible:ring-primary-400 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      selected: {
