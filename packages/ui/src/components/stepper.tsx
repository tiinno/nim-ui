        ...
        return (
          ...
          >
            {onStepChange ? (
              <button
                type="button"
 className="relative z-10 flex min-w-0 items-center gap-3 rounded-md text-left transition-colors hover:text-neutral-950 focus-visible:outline-2 focus-visible:outline-primary-500 dark:focus-visible:outline-primary-400 focus-visible:outline-offset-2 dark:hover:text-neutral-50"
