  ...
  (
    ...
    return (
      <div className="w-full">
        <div
          className={cn(
            'flex min-h-9 w-full flex-wrap items-center gap-1.5 rounded-md border border-neutral-300 bg-white px-2 py-1.5 text-sm shadow-control transition-[border-color,box-shadow] focus-within:outline-2 focus-within:outline-primary-500 dark:focus-within:outline-primary-400 focus-within:outline-offset-2 dark:border-neutral-700 dark:bg-neutral-900',
