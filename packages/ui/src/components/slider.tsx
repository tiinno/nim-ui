...
const sliderThumbVariants = cva(
  'block cursor-pointer rounded-full border-2 border-primary-600 bg-white shadow-sm transition-colors duration-(--duration-fast) dark:border-primary-400 dark:bg-neutral-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 dark:focus-visible:ring-primary-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      size: {
        sm: 'h-3 w-3',
