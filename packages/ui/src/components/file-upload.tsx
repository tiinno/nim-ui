    ...
    return (
      <div className={cn('w-full space-y-2', className)}>
        <label
          htmlFor={inputId}
          className={cn(
            'flex min-h-32 cursor-pointer flex-col items-center justify-center rounded-md border border-dashed border-neutral-300 bg-white px-4 py-5 text-center shadow-control transition-colors hover:border-neutral-400 hover:bg-neutral-50 focus-within:outline-2 focus-within:outline-primary-500 dark:focus-within:outline-primary-400 focus-within:outline-offset-2 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-neutral-600 dark:hover:bg-neutral-800',
