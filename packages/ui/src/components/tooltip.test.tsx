      ...
      fc.assert(
        fc.property(
          ...
          (variant) => {
            ...
            // Reduced-motion counterparts. Tooltip opens on
            // `data-[state=delayed-open]`, not `open`, and the prefix must
            ...
            expect(classes).toContain('data-[state=delayed-open]:motion-reduce:animate-none');
