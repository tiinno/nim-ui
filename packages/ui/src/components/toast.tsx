...
>(({ className, children, ...props }, ref) => (
  <ToastPrimitive.Close
    ...
    className={cn(
      ...
      'hover:text-neutral-900 focus-visible:outline-2 focus-visible:outline-primary-500 dark:focus-visible:outline-primary-400 focus-visible:outline-offset-2',
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Action
    ...
    className={cn(
      ...
      'hover:bg-neutral-100 focus-visible:outline-2 focus-visible:outline-primary-500 dark:focus-visible:outline-primary-400 focus-visible:outline-offset-2',
