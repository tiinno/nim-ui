...
const resizableHandleVariants = cva(
  'group relative flex shrink-0 grow-0 touch-none select-none items-center justify-center bg-neutral-200 transition-colors duration-(--duration-fast) focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 dark:focus-visible:outline-primary-400 dark:bg-neutral-800',
  {
    variants: {
      direction: {
