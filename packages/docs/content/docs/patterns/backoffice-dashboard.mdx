...
import { BackofficeDashboardDemo } from '@/components/demos/BackofficeDashboardDemo';
...
<ComponentPreview title="Operations Dashboard" fullBleed className="p-4 sm:p-6">
  <BackofficeDashboardDemo />
    ...
    <div className="space-y-5">
      <PageHeader>
        <div className="space-y-2">
          ...
          <PageHeaderDescription>Triage fulfillment risk, export the queue, and push urgent orders to the floor.</PageHeaderDescription>
        </div>
