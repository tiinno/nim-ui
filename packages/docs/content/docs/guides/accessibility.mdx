...
- Text and interactive colours are chosen against WCAG's ratios; the focus indicator is the one measured and build-guarded case (see [Color Contrast Guidelines](#color-contrast-guidelines))
