...
import { alertSignUp, alertLearnMore } from '@/components/demo-handlers';

import { Hero } from '@/components/nim';
...
<ComponentPreview title="Hero with Click Handlers">
  <Hero
    ...
    primaryCta={{ label: "Sign Up Free", onClick: alertSignUp }}
    secondaryCta={{ label: "Learn More", onClick: alertLearnMore }}
  />
