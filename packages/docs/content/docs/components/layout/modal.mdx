...
import { ModalBasic, ModalWithDescription, ModalWithCloseButton } from '@/components/demos/ModalDemo';
...
<Modal>
  ...
  <ModalContent>
    <ModalHeader>
      ...
      <ModalDescription>This action cannot be undone. This will permanently delete the item and all associated data.</ModalDescription>
    </ModalHeader>
    <ModalBody>
    ...
    <Modal open={open} onOpenChange={setOpen}>
      ...
      <ModalContent>
        <ModalHeader>
          ...
          <ModalDescription>Fill out the form below to create a new item.</ModalDescription>
        </ModalHeader>
        <ModalBody>
