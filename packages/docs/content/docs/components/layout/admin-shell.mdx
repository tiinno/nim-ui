...
<ComponentPreview title="Operations Shell" className="block">
  <AdminShell className="h-[620px] min-h-0 overflow-hidden rounded-md border border-neutral-200 dark:border-neutral-800">
        ...
        <AdminShellMain className="space-y-5">
          <PageHeader>
            <div className="space-y-2">
              ...
              <PageHeaderDescription>Review risk signals, assignment gaps, and fulfillment blockers before warehouse cutoff.</PageHeaderDescription>
            </div>
