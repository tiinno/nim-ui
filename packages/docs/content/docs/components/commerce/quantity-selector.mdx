...
import { logValue } from '@/components/demo-handlers';

import { QuantitySelector } from '@/components/nim';
...
<ComponentPreview title="Basic QuantitySelector">
  <QuantitySelector value={1} onChange={logValue} />
...
<ComponentPreview title="QuantitySelector Sizes">
  <div className="flex flex-col items-center gap-2">
    <span className="text-xs font-medium text-fd-muted-foreground">Small · `sm`</span>
    <QuantitySelector value={1} size="sm" onChange={logValue} />
  </div>
  <div className="flex flex-col items-center gap-2">
    <span className="text-xs font-medium text-fd-muted-foreground">Medium · `md`</span>
    <QuantitySelector value={1} size="md" onChange={logValue} />
  </div>
  <div className="flex flex-col items-center gap-2">
    <span className="text-xs font-medium text-fd-muted-foreground">Large · `lg`</span>
    <QuantitySelector value={1} size="lg" onChange={logValue} />
  </div>
