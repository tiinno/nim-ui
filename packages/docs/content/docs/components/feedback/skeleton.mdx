...
import { SkeletonGroupToggleDemo, SkeletonGroupLoadedLabelDemo } from '@/components/demos/SkeletonDemo';
...
<ComponentPreview title="loadedLabel" description="The same toggle, announcing when the load finishes rather than falling silent">
  <SkeletonGroupLoadedLabelDemo />
