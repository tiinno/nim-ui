...
import { PopoverBasicDemo, PopoverVariantsDemo, PopoverArrowDemo, PopoverSidesDemo, PopoverCloseDemo } from '@/components/demos/PopoverDemo';
...
<PropsTable
  props={[
    ...
    { name: 'padding', type: "'none' | 'sm' | 'md'", default: "'md'", description: 'Inner padding — use "none" when the panel hosts its own chrome' },
