...
import { DropdownMenuBasicDemo, DropdownMenuVariantsDemo, DropdownMenuCheckboxDemo, DropdownMenuRadioDemo, DropdownMenuSubMenuDemo } from '@/components/demos/DropdownMenuDemo';
...
<PropsTable
  props={[
    { name: 'variant', type: "'default' | 'outline'", default: "'default'", description: "Visual style variant for the sub-menu panel; matches the values and default of DropdownMenuContent's own variant prop." },
  ]}
/>
