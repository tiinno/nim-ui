...
import { BackofficeOperationsTemplateDemo } from '../../../components/BackofficeOperationsTemplateDemo';
...
<ComponentPreview title="Operations Workspace" className="block p-0 sm:p-0">
  <BackofficeOperationsTemplateDemo client:only="react" />
