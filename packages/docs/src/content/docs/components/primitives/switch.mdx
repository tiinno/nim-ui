...
<ComponentPreview title="Default Switch">
  <div className="flex items-center gap-3">
    ...
    <label for="default-switch" className="text-sm font-medium">Toggle me</label>
  </div>
...
<ComponentPreview title="Switch with Labels">
  <div className="flex items-center gap-3">
    ...
    <label for="airplane-mode" className="text-sm font-medium">Airplane Mode</label>
  </div>
  <div className="flex items-center gap-3">
    <Switch client:load id="dark-mode" />
    <label for="dark-mode" className="text-sm font-medium">Dark Mode</label>
  </div>
  <div className="flex items-center gap-3">
    <Switch client:load id="notifications" />
    <label for="notifications" className="text-sm font-medium">Notifications</label>
  </div>
...
<ComponentPreview title="Switch Sizes">
  <div className="flex items-center gap-3">
    ...
    <label for="switch-sm" className="text-sm font-medium">Small</label>
  </div>
  <div className="flex items-center gap-3">
    <Switch client:load size="md" id="switch-md" />
    <label for="switch-md" className="text-sm font-medium">Medium</label>
  </div>
  <div className="flex items-center gap-3">
    <Switch client:load size="lg" id="switch-lg" />
    <label for="switch-lg" className="text-sm font-medium">Large</label>
  </div>
...
<ComponentPreview title="Disabled State">
  <div className="flex items-center gap-3">
    ...
    <label for="disabled-off" className="text-sm font-medium text-gray-400">Disabled (off)</label>
  </div>
  <div className="flex items-center gap-3">
    <Switch client:load id="disabled-on" disabled checked={true} />
    <label for="disabled-on" className="text-sm font-medium text-gray-400">Disabled (on)</label>
  </div>
