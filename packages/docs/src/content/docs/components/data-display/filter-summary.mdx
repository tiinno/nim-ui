...
<ComponentPreview title="Active Filters" className="block">
  <FilterSummary client:only="react" aria-label="Active order filters" className="w-full">
    <FilterSummaryList>
      <FilterSummaryItem label="Status" value="Open" onRemove={() => undefined} />
      <FilterSummaryItem label="Risk" value="High" onRemove={() => undefined} />
      <FilterSummaryItem label="Warehouse" value="BKK-02" onRemove={() => undefined} />
    </FilterSummaryList>
...
<ComponentPreview title="Search and Active Filters" className="block">
  <div className="w-full space-y-3">
    <DataToolbar client:only="react" aria-label="Order table controls">
      <DataToolbarSearch>
    ...
    <FilterSummary client:only="react" aria-label="Active order filters">
      <FilterSummaryList>
        <FilterSummaryItem label="Status" value="Open" onRemove={() => undefined} />
        <FilterSummaryItem label="Risk" value="High" onRemove={() => undefined} />
      </FilterSummaryList>
...
<ComponentPreview title="No Active Filters">
  <FilterSummary client:only="react" aria-label="Active filters">
