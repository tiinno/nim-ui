...
<ComponentPreview title="Basic FormField">
  <FormField client:load label="Email address" name="email">
    <Input client:load type="email" placeholder="you@example.com" />
  </FormField>
...
<ComponentPreview title="Required FormField">
  <FormField client:load label="Full name" name="fullName" required>
    <Input client:load placeholder="Enter your full name" />
  </FormField>
...
<ComponentPreview title="FormField with Helper Text">
  ...
  >
    <Input client:load type="password" placeholder="Enter password" />
  </FormField>
...
<ComponentPreview title="FormField with Select">
  <FormField client:load label="Country" name="country" required>
    <Select
      client:load
      options={[
...
<ComponentPreview title="FormField with Textarea">
  ...
  >
    <Textarea client:load placeholder="Tell us about yourself..." rows={4} />
  </FormField>
...
<ComponentPreview title="Form with Multiple FormFields">
  <form className="flex flex-col gap-4 w-full max-w-md">
    <FormField client:load label="First name" name="firstName" required>
      <Input client:load placeholder="Jane" />
    </FormField>
    <FormField client:load label="Last name" name="lastName" required>
      <Input client:load placeholder="Doe" />
    </FormField>
    <FormField client:load label="Email" name="email" required helperText="We will never share your email.">
      <Input client:load type="email" placeholder="jane@example.com" />
    </FormField>
    <FormField client:load label="Role" name="role">
      <Select
        client:load
        options={[
    ...
    <FormField client:load label="Message" name="message">
      <Textarea client:load placeholder="Anything else you'd like to share?" rows={3} />
    </FormField>
  </form>
