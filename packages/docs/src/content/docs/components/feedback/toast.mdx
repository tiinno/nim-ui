...
import { ToastBasicDemo, ToastVariantsDemo, ToastWithActionDemo, ToastPageToaster } from '../../../../components/ToastDemo';
...
{/* Single Toaster instance for all demos on this page */}
<ToastPageToaster client:only="react" />
