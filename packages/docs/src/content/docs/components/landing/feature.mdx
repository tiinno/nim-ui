...
<ComponentPreview title="2-Column Grid">
  <FeatureGrid client:load columns={2}>
    <FeatureCard
      client:load
      icon={<span style={{ fontSize: '1.5rem' }}>🔒</span>}
      title="Type Safe"
...
<ComponentPreview title="4-Column Grid">
  <FeatureGrid client:load columns={4}>
    <FeatureCard
      client:load
      title="24 Components"
    ...
    <FeatureCard
      client:load
      title="Tailwind v4"
      description="Built on the latest Tailwind."
    />
    <FeatureCard
      client:load
      title="React 19"
      description="Leveraging the newest features."
    />
  </FeatureGrid>
...
<ComponentPreview title="Feature Cards Without Icons">
  <FeatureGrid client:load columns={3}>
    <FeatureCard
      client:load
