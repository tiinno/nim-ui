...
import { CTA, Button } from '@tiinno-ui/components';
...
```tsx
import { CTA } from '@tiinno-ui/components';
```
...
<ComponentPreview title="Default CTA">
  <CTA
    ...
    description="Start building beautiful interfaces with Tiinno UI today."
...
<ComponentPreview title="Default Variant">
  <CTA
    ...
    description="Connect with thousands of developers using Tiinno UI."
    buttonText="Join Now"
  />
...
function LandingFooterCTA() {
  return (
    <CTA
      ...
      description="Join 10,000+ developers already building with Tiinno UI. Free and open source."
      buttonText="Get Started"
      buttonHref="/getting-started/installation/"
      secondaryAction={
        <a
...
function UpgradePrompt() {
  return (
    <CTA
      ...
      description="Upgrade to Tiinno Pro for premium components, custom themes, and dedicated support."
