...
<ComponentPreview title="Basic Tabs">
  <Tabs client:load defaultValue="tab1" className="w-full">
    <TabsList client:load>
      <TabsTrigger client:load value="tab1">Tab 1</TabsTrigger>
      <TabsTrigger client:load value="tab2">Tab 2</TabsTrigger>
      <TabsTrigger client:load value="tab3">Tab 3</TabsTrigger>
    </TabsList>
    <TabsContent client:load value="tab1">
      <p className="text-sm text-neutral-700 dark:text-neutral-300 p-4">Content for Tab 1. This is the first panel.</p>
    </TabsContent>
    <TabsContent client:load value="tab2">
      <p className="text-sm text-neutral-700 dark:text-neutral-300 p-4">Content for Tab 2. This is the second panel.</p>
    </TabsContent>
    <TabsContent client:load value="tab3">
...
<ComponentPreview title="Tabs with Rich Content">
  <Tabs client:load defaultValue="overview" className="w-full">
    <TabsList client:load>
      <TabsTrigger client:load value="overview">Overview</TabsTrigger>
      <TabsTrigger client:load value="features">Features</TabsTrigger>
      <TabsTrigger client:load value="pricing">Pricing</TabsTrigger>
    </TabsList>
    <TabsContent client:load value="overview">
    ...
    <TabsContent client:load value="features">
      <div className="p-4 space-y-2">
    ...
    <TabsContent client:load value="pricing">
      <div className="p-4 space-y-2">
...
<ComponentPreview title="Disabled Tab">
  <Tabs client:load defaultValue="active" className="w-full">
    <TabsList client:load>
      <TabsTrigger client:load value="active">Active</TabsTrigger>
      <TabsTrigger client:load value="disabled" disabled>Disabled</TabsTrigger>
      <TabsTrigger client:load value="another">Another</TabsTrigger>
    </TabsList>
    <TabsContent client:load value="active">
      <p className="text-sm text-neutral-700 dark:text-neutral-300 p-4">This tab is active.</p>
    </TabsContent>
    <TabsContent client:load value="another">
