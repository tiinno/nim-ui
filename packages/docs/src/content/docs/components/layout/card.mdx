...
import { Card, CardHeader, CardContent, CardFooter } from '@tiinno-ui/components';
...
<ComponentPreview title="Basic Card">
  <Card client:load className="w-full max-w-sm">
...
<ComponentPreview title="Full Card with Header, Content, and Footer">
  <Card client:load className="w-full max-w-sm">
    ...
    <CardFooter client:load>
      <Button client:load variant="primary" size="sm">Save</Button>
      <Button client:load variant="outline" size="sm">Cancel</Button>
    </CardFooter>
  </Card>
...
<ComponentPreview title="Custom Styled Cards">
  <Card client:load className="w-full max-w-sm shadow-lg">
    <CardContent client:load>
      <p className="text-sm text-neutral-700 dark:text-neutral-300">Elevated card with shadow-lg</p>
    </CardContent>
  </Card>
  <Card client:load className="w-full max-w-sm border-primary-500 border-2">
    <CardContent client:load>
      <p className="text-sm text-neutral-700 dark:text-neutral-300">Card with custom border color</p>
    </CardContent>
  </Card>
  <Card client:load className="w-full max-w-sm bg-primary-50 dark:bg-primary-900/20">
    <CardContent client:load>
