...
import { Accordion, AccordionItem, AccordionTrigger, AccordionContent } from '@tiinno-ui/components';
...
<ComponentPreview title="Single Accordion">
  <Accordion client:only="react" type="single" collapsible className="w-full">
