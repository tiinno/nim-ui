---
title: Colors
description: Color palette and design tokens for Tiinno UI
---

import ColorSwatch from '../../../components/ColorSwatch.astro';

Tiinno UI uses a carefully crafted color system built on semantic color scales. All colors are designed to work in both light and dark modes with proper contrast ratios.
